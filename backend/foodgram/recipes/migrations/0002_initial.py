# Generated by Django 3.2 on 2023-06-04 13:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='shoppingcart',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name='Ингредиент в корзине должен быть уникальным'),
        ),
        migrations.AddConstraint(
            model_name='ingredientinrecipe',
            constraint=models.UniqueConstraint(fields=('recipe', 'ingredient'), name='Нельзя добавить два одинаковых ингредиента'),
        ),
        migrations.AddConstraint(
            model_name='favorite',
